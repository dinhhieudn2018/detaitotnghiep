...
@section('style')
    <style>
        .plus{background:#fed700;border:none;width:23px}
        .button-delete{
            border:0;
            outline:none;
        }
                                        ...
                                        @foreach($carts as $cart)
                                            <tr class="cart_item" id="delete-{{$cart->rowId}}">
                                                ...
                                                <td class="product-subtotal" id="total-{{$cart->rowId}}">
                                                    <span style="color:red;font-weight: bold" class="amount">{{ number_format($cart->qty * $cart->price,0) }} VND </span>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else
                                ...
                                <div class="cross-sells woocommerce">
                                    ...
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            @else
                                            <p style="font-weight: bold;">Vui lòng <a href="{{URL::route('get-login-user')}}">ĐĂNG NHẬP</a> trước khi kiểm tra</p>
                                            @endif
                                        </div>
                                    </div>
                                    <br>
                                ...
                                <div class="cart_totals ">
                                    ...
                                    <table cellspacing="0">
                                        ...
                                        <tr class="order-total" id="order-total">
                                            <th>Tổng tiền</th>
                                            <td><strong><span  style='color:red;font-weight:bold;' class="amount">{{Cart::subtotal(0)}} VND</span></strong> </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
