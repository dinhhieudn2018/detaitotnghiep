        ...
        <div class="col-md-6 col-md-offset-3">
            <form  method="POST" action="{{ route('register') }}" class="form-horizontal">
                <div class="form-group">
                    <label for="name" class="col-sm-4 control-label"> Tên người dùng</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="password" class="col-sm-4 control-label">Mật khẩu{{-- {{ __('Password') }} --}}</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label for="password-confirm" class="col-sm-4 control-label">Xác nhận mật khẩu{{-- {{ __('Confirm Password') }} --}}</label>
                    <div class="col-sm-8">
